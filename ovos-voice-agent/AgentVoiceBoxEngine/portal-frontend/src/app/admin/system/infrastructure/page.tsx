 ...
 * Links to PostgreSQL, Redis, and Vault configuration pages
 */

import Link from "next/link";
import { Database, HardDrive, Lock, ArrowRight, CheckCircle, AlertCircle } from "lucide-react";
...
const infrastructureServices = [
  {
    ...
    href: "/admin/system/infrastructure/postgres",
    icon: Database,
    settings: ["Connection Pool", "Memory Buffers", "Query Logging"],
  },
  {
    name: "Redis",
    description: "In-memory cache and session storage",
    href: "/admin/system/infrastructure/redis",
    icon: HardDrive,
    settings: ["Memory Limit", "Eviction Policy", "Persistence"],
  },
  {
    name: "Vault",
    description: "Secrets management and encryption",
    href: "/admin/system/infrastructure/vault",
    icon: Lock,
    settings: ["Seal Status", "Secret Engines", "Policies"],
  },
];
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Configure core infrastructure services: database, cache, and secrets management
        </p>
      </div>
