...
class SessionCreate(Schema):
    ...
    metadata: dict[str, Any] = {}  # (Optional) Additional, unstructured session metadata.
...
class SessionResponse(Schema):
    ...
    audio_output_seconds: float  # Total duration of synthesized audio output in seconds.
