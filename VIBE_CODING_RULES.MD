...
- **UI Framework:** Lit 3.x Web Components ONLY. No Alpine.js; React must be migrated when touched.
...
- FastAPI references must be removed once Django parity exists.
    REINGORCES OF ARCHTECTURE AND PATTERNS
